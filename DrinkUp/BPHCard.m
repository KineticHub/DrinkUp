...
- (BOOL)valid {
    ...
    if (![self numberValid]) {
        [self.errors addObject:@"Card number is not valid"];
        valid = false;
    }
    
    if ([self expired]) {
        [self.errors addObject:@"Card is expired"];
        valid = false;
    }
    
    if (![self securityCodeValid]) {
        [self.errors addObject:@"Security code is not valid"];
        valid = false;
    }
